...
- Update `DEMO_MESSAGES` inside `assistant-chat-demo.tsx` to reflect your product story.
...
<Tabs items={["CLI", "Manual"]}>
  ...
  <Tab value="Manual">
    <Steps>
      ...
      <Step>
        Copy the component source from `src/components/assistant-chat-demo.tsx`.
      </Step>
    </Steps>
